...
namespace ClientWPF
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            hoteldc = new HotelDC(Properties.Settings.Default.db_connection);

            // Якщо бази даних немає, необхідно її створити
            if (!hoteldc.DatabaseExists())
                hoteldc.CreateDatabase();
        ...
        private void DeleteHotelRoom(object sender, RoutedEventArgs e)
        {
            ...
            if (listBox.SelectedIndex >= 0)
            {
                ...
                if (hoteldc.Booking.Where(b => b.id_room == room.id).FirstOrDefault() != null)
                {
        ...
        // Обробний подій при натисканні на пункт меню довідника бронювань
